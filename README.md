...
- l'une sans démontage, encore a l’étude, nécessitera peut être une alimentation et amplification en parallèle, car le son sera pris par le port jack d'un niveau tres faible, meme a fond.

- la voie la plus simple est donc aujourd'hui de remplacer le HP interne de la Miyoo, et connecter un plus gros HP, sur le cote, par exemple, pour pouvoir laisser tomber la Telmi dans le lit, et profiter du son qui se propage par le galbe de la anse... ( il est possible de placer un HP a l’arrière de la Telmi aussi, c'est inclus dans le fichier freecad, il suffit de me le demander, j'uploaderai les versions optionnelles au besoin, une version sans anse est possible).
